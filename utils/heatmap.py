...
class yolov8_heatmap:
    ...
    def draw_detections(self, box, color, name, img):
        ...
        # 设置 Times New Roman 字体路径和字体大小
        font = ImageFont.truetype("/usr/share/fonts/truetype/msttcorefonts/Times_New_Roman.ttf", 38)  # 根据安装位置指定路径

        # 绘制文本，设置字体和大小
        draw.text((xmin, ymin - 40), str(name), font=font, fill=(int(color[0]), int(color[1]), int(color[2])))
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/534_jpg.rf.86432e643e7b2dff69930ecf9132ea47.pdf')
        
def get_params():
    params = {
        # 'weight': 'runs/train/brain_tumor_02_11/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'weight': 'runs/train/road_mark_11_CGA/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cpu',
...
if __name__ == '__main__':
    ...
    # model(r'dataset/road_mark/test/images/326b_jpg.rf.97a4308cf2bf1750c42651d5b91fb987.jpg', 'result/HiResCAM-road-mark-11-CGA-test2')
    model(r'dataset/road_mark/test/images/534_jpg.rf.86432e643e7b2dff69930ecf9132ea47.jpg', 'result/HiResCAM-road-mark-11-CGA-test2')
    # model(r'dataset/road_mark/test/images/553a_jpg.rf.be9aa8911d55a2dd3c0bca971b4758a9.jpg', 'result/HiResCAM-road-mark-11-CGA-test2')
    # model(r'dataset/brain_tumor_02/test/images/62-4_png.rf.80810f29d53a96aff2db232c35ec958e.jpg', 'result/HiResCAM-11-test2')
    # model(r'dataset/brain_tumor_02/test/images/1011-1_png.rf.4b128e7e346aac4aa713a6e92d6e14b0.jpg', 'result/HiResCAM-11-test2')
    # model(r'dataset/brain_tumor_02/test/images/2296_jpg.rf.299201a739748a60fcd4cfcd51be3e40.jpg', 'result/HiResCAM-11-test2')